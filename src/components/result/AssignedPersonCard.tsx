  ...
  return (
    <div className="flex flex-col items-center gap-4 py-8 relative">
      ...
      <div className="text-center space-y-3 max-w-md">
        <h2
          className="text-5xl font-semibold text-red-500 dark:text-red-400 drop-shadow-sm"
        ...
        <div className="bg-gradient-to-r from-red-50 to-green-50 dark:from-red-950 dark:to-green-950 border-2 border-dashed border-red-300 dark:border-red-700 rounded-lg p-4">
          <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
            🤫 <strong>Psst... To nasza mała świąteczna tajemnica!</strong>
            <br />
            Zachowaj to dla siebie i przygotuj się na rozesłanie prawdziwej świątecznej magii. Czas sprawić, by te
            Święta były niezapomniane! 🎄✨
          </p>
        </div>
      </div>
    </div>
